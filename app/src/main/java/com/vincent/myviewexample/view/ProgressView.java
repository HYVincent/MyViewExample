...
//                            Log.d(TAG, "split: 找到为空的字符！！！当前index-->"+j+" 当前字符-->"+String.valueOf(textCharArray[j]));
    ...
    public void setMCurrentCircleRadius(float mCurrentCircleRadius) {
        this.mCurrentCircleRadius = mCurrentCircleRadius;
    }
...
//        ObjectAnimator animator = ObjectAnimator.ofFloat(mContext, "progress", 0, mCircleRadius);
        ObjectAnimator animator = ObjectAnimator.ofFloat(this, "mCurrentCircleRadius", 0, mCircleRadius);
